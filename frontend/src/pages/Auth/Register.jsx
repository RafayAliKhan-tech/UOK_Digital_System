...
//   const departments = ["Computer Science", "Applied Physics", "Zoology"];
...
//   return (
//     <div className="relative flex flex-col md:flex-row min-h-screen w-full overflow-hidden font-sans">
//       {/* Left Section (hidden on small screens) */}
//       <div className="relative hidden md:flex md:w-1/2 flex-col justify-center items-center bg-gradient-to-br from-green-600 to-green-700 overflow-hidden p-6 lg:p-10">
//         <div className="absolute inset-0 opacity-30 z-10">
//           <GraduationCap className="absolute top-6 left-6 w-10 h-10 lg:w-14 lg:h-14 text-green-100 animate-float-slow" />
//           <Lightbulb className="absolute top-10 right-10 w-10 h-10 lg:w-14 lg:h-14 text-yellow-200 animate-spin-slow" />
//           <BookOpen className="absolute top-1/4 left-20 w-9 h-9 lg:w-12 lg:h-12 text-green-200 animate-float-fast" />
//           <FileText className="absolute top-[60%] left-12 w-9 h-9 lg:w-12 lg:h-12 text-green-100 animate-rotate-slow" />
//           <Globe className="absolute top-1/2 right-16 w-10 h-10 lg:w-14 lg:h-14 text-green-200 animate-swing" />
//           <Laptop className="absolute top-1/2 left-1/3 w-10 h-10 lg:w-14 lg:h-14 text-green-100 animate-tilt" />
//           <Pencil className="absolute bottom-20 left-8 w-9 h-9 lg:w-12 lg:h-12 text-green-100 animate-bounce-subtle" />
...
//         <div className="text-center max-w-sm sm:max-w-md lg:max-w-lg text-white px-4 sm:px-8 z-20 drop-shadow-lg">
//           <div className="flex justify-center mb-6">
//             <img
//               src={logo}
//               alt="UOK Logo"
//               className="w-40 h-40 sm:w-56 sm:h-56 lg:w-72 lg:h-72 object-contain rounded-full drop-shadow-lg animate-fade-in"
//               style={{ filter: "brightness(0) invert(1)" }}
//             />
//           </div>
//           <h1 className="text-lg sm:text-xl lg:text-2xl font-semibold mb-3 animate-fade-in tracking-[0.17em] uppercase">
//             Break the Manual Limits
//           </h1>
//           <p className="text-sm sm:text-base lg:text-lg leading-relaxed text-green-100 animate-fade-in delay-500 underline decoration-2 underline-offset-7">
//             Register Now and Enter the Digital Revolution
//           </p>
//         </div>
//       </div>
...
//       {/* Right Section (Form) */}
//       <div className="relative w-full md:w-1/2 flex justify-center items-center px-4 sm:px-6 md:px-8 py-8 bg-white overflow-y-auto md:overflow-hidden">
//         <div className="w-full max-w-xs sm:max-w-sm md:max-w-md bg-white rounded-xl sm:rounded-2xl shadow-lg sm:shadow-2xl p-5 sm:p-8 border border-gray-100 animate-fade-in-up z-10">
...
const Register = () => {
  ...
  return (
    <div className="relative flex flex-col md:flex-row min-h-screen w-full overflow-hidden font-sans">
      ...
      {/* Right Section (Form) */}
      <div className="relative w-full md:w-1/2 flex flex-col justify-center items-center px-4 sm:px-6 md:px-8 py-8 bg-white overflow-hidden">
        {/* Mobile Header */}
